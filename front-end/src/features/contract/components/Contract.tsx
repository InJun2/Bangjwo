    ...
    useImperativeHandle(ref, () => ({
      getFormData: (): UpdateLandlordInfoDto => {
        const formData = {
          ...
          contractFee: contractFee === "" ? 0 : Number(contractFee),
          middleFee: middleFee === "" ? 0 : Number(middleFee),
          interimPaymentDate,
          ...
          fixedManagementFee: fixedManagementFee === "" ? 0 : Number(fixedManagementFee),
          ...
          unpaidAmount: unpaidAmount === "" ? 0 : Number(unpaidAmount),
          disputeResolution: disputeResolution ?? ("" as any),
          isHousingReconstructionPlanned: isHousingReconstructionPlanned ?? ("" as any),
          constructionPeriod,
          estimatedConstructionDuration: estimatedConstructionDuration === "" ? 0 : Number(estimatedConstructionDuration),
